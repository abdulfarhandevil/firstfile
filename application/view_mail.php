                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="inbox-email-menu-list shadow-reset">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li><a data-toggle="tab" href="#inbox"><span class="inbox-icon"><i class="fa fa fa-inbox "></i></span> Inbox <span class="count-inbox">3</span></a>
                                </li>
                                <li class="active"><a data-toggle="tab" href="#viewmail"><span class="inbox-icon"><i class="fa fa fa-inbox "></i></span> View Mail</a>
                                </li>
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <div class="tab-content view-mail-ov-mg-t-30">
                            <div id="inbox" class="tab-pane fade animated zoomInDown shadow-reset custom-inbox-message">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="view-mail-reply-list">
                                                <ul class="view-mail-forword">
                                                    <li><a class="view-mail-mg-b-10" href="#"><i class="fa fa-reply"></i> Reply</a>
                                                    </li>
                                                    <li><a class="view-mail-mg-b-10" href="#"><i class="fa fa-reply"></i> Forward</a>
                                                    </li>

                ...
                <div class="sparkline13-list shadow-reset">
                    ...
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            <div class="container">
                                <div id="login"><?php echo $this->session->flashdata('message'); ?></div>
                                 <?php 
                                    if (!empty($results))
                                    {
                                 ?>
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="<?php echo site_url('uploads/').$val['profile_pic']; ?>" ></td>
                                        <td><a href="<?php echo base_url('Admin_Controller/update/'.$val['id']); ?>"><i class="fa fa-edit"></i></a></td>
                                        <td id="delete"><a href="<?php echo base_url('Admin_Controller/delete/'.$val['id']); ?>" onclick="return confirm('Are you sure you want to delete this item')"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                <?php } ?>
                                </table> 
